...
public class SubmitOrderTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("nishchay.angra@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Nishchay@18");
...
//		driver.findElement(By.xpath("//*[text()='Place Order ']")).click();
		...
		//WebElement we = driver.findElement(By.xpath("//*[text()='Place Order ']"));
		//Actions A = new Actions(driver);	
